...
import com.gallop.connect.logminer.util.CachedConnectionProvider;
...
public class JdbcDbWriter {
  ...
  JdbcDbWriter(final JdbcSinkConfig config, DatabaseDialect dbDialect) {
    this.config = config;
  ...
  void write(final Collection<SinkRecord> records)
    ...
    try {
      ...
      for (SinkRecord record : records) {
        ...
        if (buffer == null) {
          buffer = new BufferedRecords(config, tableId, dbDialect, connection);

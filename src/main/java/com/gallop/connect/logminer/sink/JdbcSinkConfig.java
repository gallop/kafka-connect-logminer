...
public class JdbcSinkConfig extends AbstractConfig {
  ...
  public static final String CONNECTION_URL = LogMinerSourceConnectorConfig.CONNECTION_URL_CONFIG;
  ...
  public static final String CONNECTION_USER = LogMinerSourceConnectorConfig.CONNECTION_USER_CONFIG;
  private static final String CONNECTION_USER_DOC = "JDBC connection user.";
  private static final String CONNECTION_USER_DISPLAY = "JDBC User";

  public static final String CONNECTION_PASSWORD =
          LogMinerSourceConnectorConfig.CONNECTION_PASSWORD_CONFIG;
  ...
  public final boolean deleteEnabled=false;
  ...
  public final Map<String, String> tableSpaceSourceSinkMap = new HashMap<>();

  public JdbcSinkConfig(Map<?, ?> props) {
    super(CONFIG_DEF, props);
    String sourceSinkMapStr = (String)props.get("tablespace.sourceSinkMap");
    createSourceSinkMap(sourceSinkMapStr);
  ...
  private void createSourceSinkMap(String sourceSinkStr){
    if(sourceSinkStr==null || "".equals(sourceSinkStr)){
      return;
    }
    String[] splits = sourceSinkStr.split(",");
    for (String item : splits){
      String[] element = item.split(":");
      tableSpaceSourceSinkMap.put(element[0],element[1]);
    }
    System.out.println(">>>>>>>>>>>>>==============================tableSpaceSourceSinkMap:"+tableSpaceSourceSinkMap);
  }

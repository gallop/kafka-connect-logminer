...
import com.gallop.connect.logminer.sink.dialect.DatabaseDialect.ColumnConverter;

import com.gallop.connect.logminer.util.ColumnDefinition;
 ...
 *
 * <p>This mapping contains the {@link DatabaseDialect.ColumnConverter} functions that should be called for each row

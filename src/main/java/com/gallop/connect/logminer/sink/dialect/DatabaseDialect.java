...
import com.gallop.connect.logminer.sink.ColumnMapping;
import com.gallop.connect.logminer.sink.JdbcSinkConfig;
import com.gallop.connect.logminer.sink.TimestampIncrementingCriteria;
 ...
 * the parent class' method to handle the generic cases. The { PostgreSqlDatabaseDialect} is a
 ...
 * object and uses the Dialect's { #addFieldToSchema(ColumnDefinition, SchemaBuilder)} method
 ...
 * file a {@code META-INF/services/DatabaseDialectProvider} file
